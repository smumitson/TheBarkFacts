"""Builds deep-dive pages for batch 4 and updates index + breed CTAs."""
import os, re, openpyxl

BREEDS = [
    (
        'norwegian-elkhound', 'Norwegian Elkhound',
        'Viking hunting dog. Will absolutely tell you about the neighbor&rsquo;s cat.',
        'norwegian_elkhound_1.jpg',
        'An ancient, vocal Nordic hunter &mdash; loyal to family, loud about everything else.',
    ),
    (
        'otterhound', 'Otterhound',
        'Rare. Shaggy. Incredibly loud about finding a scent.',
        'otterhound_3.jpg',
        'One of the rarest breeds alive &mdash; a boisterous, water-loving hound that needs serious exercise.',
    ),
    (
        'papillon', 'Papillon',
        'Butterfly ears. Agility champion. Somehow also a couch dog.',
        'papillon_1.jpg',
        'An underrated toy breed &mdash; genuinely trainable, athletic, and nothing like the fragile lap dog it looks.',
    ),
    (
        'pekingese', 'Pekingese',
        '2,000 years of imperial dignity. Hasn&rsquo;t forgotten a day of it.',
        'pekingese_3.jpg',
        'Ancient palace companion &mdash; the flat face is a real health consideration, not just a look.',
    ),
    (
        'pointer', 'Pointer',
        'Built purely for the field. Profoundly uninterested in your walk.',
        'pointer_2.jpg',
        'A stamina athlete built for all-day field work &mdash; not a casual-exercise breed.',
    ),
    (
        'poodle', 'Poodle',
        'Smartest dog in the room. The haircut is optional. The intelligence isn&rsquo;t.',
        'poodle_4.jpg',
        'The intelligent athlete behind the show-dog reputation &mdash; demanding, trainable, and not low-maintenance.',
    ),
    (
        'portuguese-water-dog', 'Portuguese Water Dog',
        'Fished with sailors. Currently redirecting that energy at your furniture.',
        'portuguese_water_dog_1.jpg',
        'An athletic, water-loving working dog &mdash; needs more than a walk to be genuinely content.',
    ),
    (
        'pug', 'Pug',
        'Smooshed face. Loud breathing. Pure, unfiltered love.',
        'pug_5.jpg',
        'Genuinely charming &mdash; and the brachycephalic health realities are just as real as the personality.',
    ),
    (
        'rottweiler', 'Rottweiler',
        'Intimidating reputation. Actual softie. Currently on your couch.',
        'rottweiler_1.jpg',
        'A misunderstood, deeply loyal family dog &mdash; the work is socialization, not managing aggression.',
    ),
    (
        'saint-bernard', 'Saint Bernard',
        'Alpine rescue legend. Currently drooling on your furniture.',
        'saint_bernard_3.jpg',
        'The gentle giant rescue dog &mdash; patient with everyone, less so about personal space.',
    ),
]
...
# Full alphabetical index — 45 breeds
ALL_CARDS = [

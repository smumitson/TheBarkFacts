"""Builds deep-dive pages for batch 2 and updates index + breed CTAs."""
import os, re, openpyxl

BREEDS = [
    (
        'brussels-griffon', 'Brussels Griffon',
        'Tiny face. Enormous feelings. Follows you everywhere.',
        'brussels_griffon_3.jpg',
        'A velcro companion in a tiny, opinionated package &mdash; more emotionally demanding than it looks.',
    ),
    (
        'bull-terrier', 'Bull Terrier',
        'Egg head. Clown soul. Surprisingly hard to say no to.',
        'bull_terrier_3.jpg',
        'The class clown with a stubborn streak &mdash; funny until training gets ignored.',
    ),
    (
        'bulldog', 'Bulldog',
        'Maximum wrinkles. Minimum effort. Champion napper.',
        'bulldog_1.jpg',
        'The original couch potato &mdash; charming, low-key, and carrying real health tradeoffs.',
    ),
    (
        'chihuahua', 'Chihuahua',
        'Five pounds. Infinite attitude. Absolutely certain it&rsquo;s in charge.',
        'chihuahua_5.jpg',
        'Tiny body, outsized personality &mdash; needs real training despite the small packaging.',
    ),
    (
        'chow-chow', 'Chow Chow',
        'Ancient. Dignified. Not performing for you today.',
        'chow_chow_1.jpg',
        'Reserved, serious, and deeply independent &mdash; not a dog for everyone.',
    ),
    (
        'dachshund', 'Dachshund',
        'Long back. Short legs. Unlimited stubbornness.',
        'dachshund_7.jpg',
        'A surprisingly bold hunting dog in a hot-dog shape &mdash; that spine needs protecting.',
    ),
    (
        'dalmatian', 'Dalmatian',
        'Born spotty. Born athletic. Not stopping anytime soon.',
        'dalmation_6.jpg',
        'The endurance athlete behind the Disney image &mdash; demanding and diet-specific.',
    ),
    (
        'doberman', 'Doberman',
        'Velcro dog in a guard-dog costume. Extremely devoted.',
        'doberman_2.jpg',
        'Loyal, sensitive, and misunderstood &mdash; the real challenge is cardiac health, not temperament.',
    ),
    (
        'english-toy-spaniel', 'English Toy Spaniel',
        'Royal heritage. Lap dog by vocation. Zero apologies.',
        'english_toy_spaniel_2.jpg',
        'A calm, devoted companion &mdash; genuinely easy to live with, with health caveats worth knowing.',
    ),
    (
        'finnish-lapphund', 'Finnish Lapphund',
        'Herded reindeer for centuries. Currently managing your calendar.',
        'finnish_lapphund_1.jpg',
        'A friendly, trainable Arctic breed &mdash; sociable, vocal, and surprisingly easygoing.',
    ),
]
...
# Update index — full alphabetical list of all 25 breeds
ALL_CARDS = [
...
# Add CTA buttons to breed pages
CTA_CSS = """\
    .deep-dive-cta {
      display: inline-block;
      background: #FFF8EC;
